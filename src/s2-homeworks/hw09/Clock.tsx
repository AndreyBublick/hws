...
function Clock() {
    ...
    const stringDate = `${String(date.getDay() + 1).padStart(2, '0')}.${String(date.getMonth() + 1).padStart(2, '0')}.${date.getFullYear()}` || <br/> // день.месяц.год (01.02.2022) // пишут студенты, варианты 01.02.0123/01.02.-123/01.02.12345 не рассматриваем

    // день недели на английском, месяц на английском (https://learn.javascript.ru/intl#intl-datetimeformat)
    const stringDay = `${date.toLocaleString('en-US', { weekday: 'long' })}` || <br/> // пишут студенты
    const stringMonth = `${date.toLocaleString('en-US', { month: "short" })}` || <br/> // пишут студенты
